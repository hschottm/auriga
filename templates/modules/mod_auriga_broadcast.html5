...
<?php endif; ?>
<div class="auriganav">
	<?php if (strlen($this->nav_first_url)): ?><a href="<?php echo $this->nav_first_url; ?>"><?php endif; ?><img src="tl_files/auriga/images/control_start<?php echo (strlen($this->nav_first_url)) ? '_blue' : ''; ?>.png" alt="<?php echo $this->nav_first_title; ?>" title="<?php echo $this->nav_first_title; ?>" /><?php if (strlen($this->nav_first_url)): ?></a><?php endif; ?>
	<?php if (strlen($this->nav_prev_url)): ?><a href="<?php echo $this->nav_prev_url; ?>"><?php endif; ?><img src="tl_files/auriga/images/control_rewind<?php echo (strlen($this->nav_prev_url)) ? '_blue' : ''; ?>.png" alt="<?php echo $this->nav_prev_title; ?>" title="<?php echo $this->nav_prev_title; ?>" /><?php if (strlen($this->nav_prev_url)): ?></a><?php endif; ?>
	<?php if (strlen($this->nav_next_url)): ?><a href="<?php echo $this->nav_next_url; ?>"><?php endif; ?><img src="tl_files/auriga/images/control_fastforward<?php echo (strlen($this->nav_next_url)) ? '_blue' : ''; ?>.png" alt="<?php echo $this->nav_next_title; ?>" title="<?php echo $this->nav_next_title; ?>" /><?php if (strlen($this->nav_next_url)): ?></a><?php endif; ?>
	<?php if (strlen($this->nav_last_url)): ?><a href="<?php echo $this->nav_last_url; ?>"><?php endif; ?><img src="tl_files/auriga/images/control_end<?php echo (strlen($this->nav_last_url)) ? '_blue' : ''; ?>.png" alt="<?php echo $this->nav_last_title; ?>" title="<?php echo $this->nav_last_title; ?>"/><?php if (strlen($this->nav_last_url)): ?></a><?php endif; ?> 
</div>
